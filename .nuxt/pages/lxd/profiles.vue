            ...
            <v-card flat>
              <v-card-text>
                <v-form ref="form" v-model="valid" lazy-validation>
                  ...
                  <v-text-field v-model="editingItem.description" :rules="nameRule" label="Description:" placeholder="" hint="Enter a description for the profile."></v-text-field>
                          </v-card-text>
                        </v-flex>
                        <v-flex xs6>
                          <v-card-text class="px-4">
                            <v-layout row wrap>
                              ...
                              <v-flex xs6>
                                <h4>Ephemeral</h4>
                                <v-switch :label="`${editingItem.ephemeral ? 'Yes' : 'No'}`" color="success" v-model="editingItem.ephemeral"></v-switch>
                              </v-flex>
                           </v-layout>
                           <v-layout row wrap>
                              <v-flex xs6>
